...
from models.users.user_model import User, UserUpdate
from datetime import datetime

users_router = APIRouter()

@users_router.post("/", response_description="Create a new user", status_code=status.HTTP_201_CREATED, response_model=User)
...
@users_router.get("/", response_description="List all users", response_model=List[User])
...
@users_router.put("/{id}", response_description="Update a user's symptoms", response_model=User)
